...
function injectVisuals(){
  ...
  .ipw-inline-host .ipw-backdrop{position:static!important;inset:auto!important;display:block!important;padding:0!important;background:transparent!important;backdrop-filter:none!important;opacity:1!important;pointer-events:auto!important;overflow:visible!important;overscroll-behavior:auto!important;touch-action:auto!important;}
  .ipw-inline-host .ipw-shell{width:100%!important;max-width:none!important;height:auto!important;min-height:0!important;max-height:none!important;border-radius:22px!important;box-shadow:0 18px 55px rgba(0,0,0,.28)!important;overflow:hidden!important;border:1px solid rgba(99,213,255,.22)!important;contain:layout paint!important;}
  .ipw-inline-host .ipw-body{height:auto!important;min-height:0!important;max-height:70vh!important;overflow-y:auto!important;overflow-x:hidden!important;-webkit-overflow-scrolling:touch!important;overscroll-behavior:contain!important;touch-action:pan-y!important;scrollbar-width:thin!important;}
  ...
  @media(max-width:700px){.ipw-inline-host .ipw-stage{padding:16px!important}.ipw-inline-host .ipw-body{max-height:68vh!important}.ipw-inline-host .ipw-field{height:130px!important}.ipw-inline-host .ipw-cards.cols2{grid-template-columns:1fr!important}.ipw-inline-host .ipw-form-name{font-size:22px!important}}
  `;
...
function convertInline(){
  ...
  if(!host){host=document.createElement('div');host.id='integratedPlanningInlineHost';host.className='ipw-inline-host';button.parentElement?.insertBefore(host,button.nextSibling)}
