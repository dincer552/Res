...
public static class M8ChanceAllocationEngine
{
    ...
    public static DiscreteChanceAllocation Calculate(double ownMidfieldRating, double opponentMidfieldRating, AdvancedTactic tactic = AdvancedTactic.Normal, double tacticStrength = 0.0)
    {
        ...
        // §4.3: one-team Pressing suppresses Normal attacks generated by both teams. The paper gives 5–41% for this case.
        var pressingSuppression = tactic == AdvancedTactic.Pressing ? CalculateRange(PressingMinSuppression, PressingMaxSuppression, tacticStrength) : 0.0;
    ...
    public static DiscreteChanceAllocation Calculate(double ownMidfieldShare)
    {
        ...
        return new DiscreteChanceAllocation(
            ...
            PaperExpectedRegularSectorChances * possession,
            PaperExpectedRegularSectorChances * (1.0 - possession),
