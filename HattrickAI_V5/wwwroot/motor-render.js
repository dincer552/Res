(function () {
  ...
  const removeOpponentSummary = () => {
    document.getElementById('oppReference')?.remove();
    document.getElementById('oppMeta')?.remove();
    document.getElementById('oppFormation')?.closest('.lineup-foot')?.remove();
  };
  removeOpponentSummary();
