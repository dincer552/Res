...
public static class SpecialtyInteractionRegression
{
    public static int Run()
    {
        ...
        Assert(SpecialtyInteractionEngine.GetTacticEffect(PlayerSpecialty.Quick, "FW-C", PlayerOrder.Normal, AdvancedTactic.Counter, 1, 0).CanCreateQuickEvent, "Quick forward event");
